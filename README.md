...
- **40+量化工具** - 市场数据、技术指标、Alpha因子、回测、风险管理、券商连接
- **18个交易策略** - SMA、MACD、RSI、布林带、一目均衡表、SMC、多因子、加密货币套利等
